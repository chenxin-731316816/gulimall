...
public class MemberReceiveAddressServiceImpl extends ServiceImpl<MemberReceiveAddressDao, MemberReceiveAddressEntity> implements MemberReceiveAddressService {
    ...
    @Override
    public void saveReceiveAddress(MemberReceiveAddressVO memberReceiveAddressVO) {
        memberReceiveAddressVO.setDefaultStatus(1);
        MemberReceiveAddressEntity memberReceiveAddress = new MemberReceiveAddressEntity();
        BeanUtils.copyProperties(memberReceiveAddressVO, memberReceiveAddress);
        memberReceiveAddress.setAlias("家里");
