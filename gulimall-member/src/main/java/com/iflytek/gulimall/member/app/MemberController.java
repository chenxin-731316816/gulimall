...
public  class MemberController implements MemberServiceAPI {
    ...
    @Override
    @RequestMapping("/saveReceiveAddress")
    public R saveReceiveAddress( @RequestBody  MemberReceiveAddressVO memberReceiveAddressVO) {
        memberReceiveAddressService.saveReceiveAddress(memberReceiveAddressVO);
        return R.ok();
    }
