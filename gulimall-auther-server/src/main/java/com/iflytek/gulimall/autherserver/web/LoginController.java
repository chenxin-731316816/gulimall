...
import com.iflytek.gulimall.common.constant.AuthorServerConstant;
...
import static com.iflytek.gulimall.common.constant.AuthorServerConstant.*;
...
public class LoginController {
    ...
    public ResultBody sendMsg(@RequestParam("phone") String phone, HttpServletRequest request) throws InterruptedException {
        //一个手机号在60s内只能发送一次
        String value = redisTemplate.opsForValue().get(AuthorServerConstant.SMS_CODE_CACHE_PREFIX + phone);
        ...
        redisTemplate.opsForValue().set(AuthorServerConstant.SMS_CODE_CACHE_PREFIX + phone,
    ...
    public String register(@Valid RegisterVO registerVO,
        ...
        if (result.hasErrors()) {
            ...
            return "redirect:" + AuthorServerConstant.URL_REGISTER;
        }
        //2、校验验证码
        ...
        String key = AuthorServerConstant.SMS_CODE_CACHE_PREFIX + phone;
