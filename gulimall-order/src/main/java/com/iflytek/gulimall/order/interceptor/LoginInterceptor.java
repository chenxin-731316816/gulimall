...
import static com.iflytek.gulimall.common.constant.AuthorServerConstant.LOGIN_USER;
import static com.iflytek.gulimall.common.constant.AuthorServerConstant.URL_LOGIN;

@Component
public class LoginInterceptor implements HandlerInterceptor {

    //把登录的用户放入ThreadLocal，其他线程都能获取到
