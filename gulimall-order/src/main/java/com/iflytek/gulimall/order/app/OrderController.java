...
public class OrderController implements OrderServiceAPI {
    ...
    public R saveReceiveAddress(MemberReceiveAddressVO memberReceiveAddressVO){
        MemberVO memberVO = LoginInterceptor.getMemberVO();
        memberReceiveAddressVO.setMemberId(memberVO.getUserId());
        memberServiceAPI.saveReceiveAddress(memberReceiveAddressVO);
        return R.ok();
    }
